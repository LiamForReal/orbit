...
start "" python "..\orbit_gui\gui.py" %RAND_NUM%
...
powershell -Command "Start-Process '..\src\Client\x64\Release\client.exe' -ArgumentList '%RAND_NUM%' -NoNewWindow -RedirectStandardOutput '%logFile%' "
